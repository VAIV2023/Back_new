...
def current_close_by_ticker(ticker):
    ...
    try:
        ...
        resp = s.get(url)
        currentClose = resp.text.split("<dd>���簡 ")[1].split(' ')[0].replace(",","")
    except:
        currentClose = 0
    return currentClose
# auto trading - sell
...
if __name__ == '__main__':
  # ���� �ֱ� ����
  # Updating Stock Data
  schedule.every().day.at("15:30").do(update_stock)   # ���� ���� 3�� 30�п� update_stock �Լ� ����
  #update_stock()
